    ...
    >
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{ 
            background: 'radial-gradient(ellipse at 80% 20%, rgba(79, 70, 229, 0.08) 0%, transparent 50%)' 
          }}
        />
        <div 
        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-12 py-24 lg:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left">
              ...
              <h1 
                className="hero-text font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight mb-6"
                style={{ opacity: 0 }}
              >
                Zaheen Parkar
              </h1>
              ...
              <h2 
                className="hero-text font-display text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-700 mb-6 leading-snug"
                style={{ opacity: 0 }}
              >
              ...
              <p 
                className="hero-text text-gray-600 text-base lg:text-lg mb-8 max-w-xl mx-auto lg:mx-0"
                style={{ opacity: 0 }}
              >
            ...
            >
              <div className="relative w-64 h-80 sm:w-80 sm:h-96 lg:w-96 lg:h-[28rem]">
                {/* Decorative elements */}
                <div className="absolute -top-4 -left-4 w-24 h-24 border-l-2 border-t-2 border-indigo-500/30 rounded-tl-2xl" />
                <div className="absolute -bottom-4 -right-4 w-24 h-24 border-r-2 border-b-2 border-indigo-500/30 rounded-br-2xl" />
